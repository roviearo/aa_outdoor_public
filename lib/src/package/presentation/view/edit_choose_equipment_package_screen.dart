...
class EditChooseEquipmentPackageScreen extends StatefulWidget {
  const EditChooseEquipmentPackageScreen({super.key});

  @override
  State<EditChooseEquipmentPackageScreen> createState() =>
      _EditChooseEquipmentPackageScreenState();
}

class _EditChooseEquipmentPackageScreenState
    extends State<EditChooseEquipmentPackageScreen> {
  int selectedIndex = -1;
  int selectedView = 0;
  ...
  Widget build(BuildContext context) {
    return KeyboardDismisser(
      child: Scaffold(
        ...
        body: BlocBuilder<EditPackageCubit, EditPackageState>(
          builder: (context, state) {
            final editPackageState = state;
            ...
            return SafeArea(
              child: Stack(
                children: [
                  ...
                  editPackageState.selectedEquipment.isNotEmpty
                      ? Column(
